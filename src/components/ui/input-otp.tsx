...
function InputOTPSlot({
  ...
  return (
      <div
          ...
          className={cn(
              // DEĞİŞİKLİK BURADA: border-y ve birleştirme sınıfları yerine tam border ve rounded verdik
              "relative flex h-12 w-12 items-center justify-center border border-input text-lg font-medium shadow-xs transition-all rounded-md outline-none",
              ...
              "dark:bg-input/30", // Kutucukların içi hafif dolu görünsün
              className
          )}
          {...props}
      >
